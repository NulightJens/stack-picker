...
/** Grace period (ms) between mouse leaving the region and closing the popover. */
      ...
      <div className="max-w-7xl mx-auto px-4 py-3 flex flex-col sm:flex-row sm:items-center gap-3">
        ...
        >
          ...
          {/* Hover popover — full vertical list of every pick.
              pt-3 extends the hover surface up to the trigger so the cursor
              never passes through a dead zone on its way here. */}
          {pickedCount > 0 && (
            <div
              onMouseEnter={openPopover}
              onMouseLeave={schedulePopoverClose}
